...
class ScheduleDaoTest {
    ...
    @Test
    fun insert_schedule_returnsScheduleId() =
        runTest {
            val schedule = createTestScheduleEntity(id = 1)
            val scheduleId = scheduleDao.insert(schedule)
            val actualSchedule = scheduleDao.getScheduleById(scheduleId.toInt().toString())
    ...
    @Test
    fun getSchedulesForTimetableInGridMode_showSundayAndSaturday() =
        runTest {
            val expectedScheduleList =
                scheduleDetailsList.toMutableList().apply {
                    removeLast()
                }
            insertSchedules()
    ...
    @Test
    fun getSchedulesForTimetableInGridMode_showSundayNotShowSaturday() =
        runTest {
            val expectedScheduleList =
                scheduleDetailsList.toMutableList().apply {
    ...
    @Test
    fun getSchedulesForTimetableInGridMode_notShowSundayShowSaturday() =
        runTest {
            val expectedScheduleList =
                scheduleDetailsList.toMutableList().apply {
    ...
    @Test
    fun getSchedulesForTimetableInGridMode_notShowSundayNotShowSaturday() =
        runTest {
            val expectedScheduleList =
                scheduleDetailsList.toMutableList().apply {
    ...
    @Test
    fun getSchedulesForTimetableInListMode_dayOfWeekMonday() =
        runTest {
    ...
    @Test
    fun getSchedulesForTimetableInListMode_dayOfWeekTuesday() =
        runTest {
    ...
    @Test
    fun get_scheduleDetailsView_by_scheduleId_returns_scheduleDetailsView() =
        runTest {
            val scheduleDetailsViewId = 1
            val expectedScheduleDetailsView = scheduleDetailsList.find { it.scheduleId == "1" }
            insertSchedules()
            val actualScheduleDetailsView = scheduleDao.getScheduleDetailsById(scheduleDetailsViewId.toString())
    ...
    private fun createTestScheduleEntity(id: Int) =
        ScheduleEntity(
            id = id.toString(),
