...
class TimetableCanvasRender
    @Inject
    constructor() {
        fun createTimetableBitmap(
            bitmapWith: Int,
            bitmapHeight: Int,
        ): Bitmap = createBitmap(bitmapWith, bitmapHeight)
        ...
        fun getCurrentMonthDayBackground(
            viewWidth: Int,
            viewHeight: Int,
