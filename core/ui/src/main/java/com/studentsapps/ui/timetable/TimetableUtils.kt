    ...
    constructor() {
        fun getDaysOfMonthOfWeek(
            ...
            val daysOfMonthOfWeek =
                (0 until 7)
                    .map { startOfWeek.plusDays(it.toLong()) }
                    .toMutableList()
        ...
        fun getCurrentMonthDay(): String = LocalDate.now().dayOfMonth.toString()
        ...
        fun calculateRealRootViewWidth(
            width: Int,
            paddingLeft: Int,
            paddingRight: Int,
        ): Int {
        ...
        ): Int = (rootViewWidth - hoursCellWidth) / (columnsNumber - columnsHourNumber)

        fun calculateTimetableBitmapHeight(
            rowsNumber: Int,
            gridCellHeight: Int,
        ): Int = rowsNumber * gridCellHeight
        ...
        ): Int = (gridCellWidth / crossedSchedulesCount) - scheduleEndMargin

        fun calculateSingleScheduleViewWidth(
            gridCellWidth: Int,
            scheduleEndMargin: Int,
        ): Int = gridCellWidth - scheduleEndMargin
