...
class PendingOperationRepositoryImp
    @Inject
    constructor(
        ...
        override fun getPendingOperations(
            ...
            pendingOperationLocalDataSource
                .getPendingOperations(status, userId)
        ...
        override fun getPendingReadOperations(
            ...
            pendingOperationLocalDataSource
                .getPendingReadOperations(operationType, entityType, userId)
                .map { it.map(PendingOperationEntity::asExternalModel) }
        ...
        override fun getFirstPendingOperation(
            ...
            pendingOperationLocalDataSource
                .getFirstPendingOperation(status, userId)
